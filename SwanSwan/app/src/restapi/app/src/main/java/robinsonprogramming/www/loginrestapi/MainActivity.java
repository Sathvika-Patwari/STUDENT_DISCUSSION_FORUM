package robinsonprogramming.www.loginrestapi;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.attr.layout.activity_main.xml);
        ...
        editText_login_password = (EditText) findViewById(android.R.attr.id.editText_login_password);
