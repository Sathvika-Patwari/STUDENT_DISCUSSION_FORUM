...
public class MainActivity extends Activity {
    ...
    String HttpURL = "https://172.20.10.8/posts.php";
                    ...
                    if (FinalJSonResult != null) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                subject.Subject_Name = jsonObject.getString("post_title");

                                subject.Subject_Full_Form = jsonObject.getString("post_desc");
